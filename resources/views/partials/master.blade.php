...
<html lang="en">
    <head>
        ...
        <title>Gestion des agréments de la DSI</title>
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                            ...
                            <li>
                                ...
                                <form action="{{route('logout')}}" method="POST">
                                    @csrf
                                    <button class="btn btn-sn btn-light" type="submit">Se déconnecter</a>
                                </form>    
                            </li>
                        </ul>
                    </li>
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="/users/create">Créer utilisateur</a>
                                    <a class="nav-link" href="/users/index">Lister utilisateur</a>
                                </nav>
                            </div>
                            @endif
                            @if (Auth::user()->role=='admin' || Auth::user()->role == 'agent')
                            <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#collapsePages" aria-expanded="false" aria-controls="collapsePages">
                                <div class="sb-nav-link-icon"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-lines-fill" viewBox="0 0 16 16">
                            ...
                            <div class="collapse" id="collapsePages" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                                    ...
                                    <a class="nav-link" href="{{route('list.providers')}}">Lister fournisseurs</a>
                            ...
                            <div class="collapse" id="collapsePage" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                                    ...
                                    <a class="nav-link" href="{{route('provider.show', Auth::user()->id)}}">Soumettre demande</a>
                                    @endif
                                    <a class="nav-link" href="{{route('demandes.index')}}">Liste des demandes</a>
                                    
                                    
                                
                                </nav>
                            </div>
                            <a class="nav-link" href="/agrements/index">
                                <div class="sb-nav-link-icon">
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid px-4">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">© 2024-Direction Générale du Budget.</div>
                        </div>
                    </div>
                </footer>
            </div>
